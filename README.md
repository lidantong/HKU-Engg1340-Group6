...
![](https://s3-ap-southeast-1.amazonaws.com/hkuengg1340project/grocery-grocer-the-grocery-store1.jpg)
...
4. To get a maximum number of cashiers from standard input. (fewer than the **default** maximum number: 50)
5. To calculate the **optimised** plan and revenue of different numbers of cashier open within the given maximum waiting time
